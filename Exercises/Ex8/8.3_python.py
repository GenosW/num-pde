...
for eps in epsilon:
    ...
    with TaskManager():
        ...
        solvers.CG(mat=a.mat, pre=c.mat, sol = gfu.vec, rhs = f.vec, tol = 1e-8, maxsteps = 934, callback = callback, printrates = False)
        #print(data [-1])
